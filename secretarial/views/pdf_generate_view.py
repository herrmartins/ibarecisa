...
class GenerateProjectPDF(PermissionRequiredMixin, View):
    permission_required = "secretarial.view_minuteprojectmodel"

    def get(self, request, *args, **kwargs):
        data = MinuteProjectModel.objects.get(pk=kwargs.get("pk"))
        ...
        if pdf:
            ...
            response[
                "Content-Disposition"
            ] = f'attachment; filename="projeto_ata_{data.pk}.pdf"'
            return response
